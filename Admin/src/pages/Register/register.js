                    ...
                    <Card id="dialog" bordered={false}>
                        ...
                        >
                            <Form.Item style={{ marginBottom: 3 }}>
                                <Divider style={{ marginBottom: 5, fontSize: 19 }} orientation="center">MEDISCUSS!</Divider>
                            </Form.Item>
                            <Form.Item style={{ marginBottom: 16 }}>
                                <p className="text">Đăng ký tài khoản người dùng</p>
                            </Form.Item>
                            ...
                            >
                                <Input prefix={<UserOutlined className="siteformitemicon" />} placeholder="Họ và tên" />
                            </Form.Item>
